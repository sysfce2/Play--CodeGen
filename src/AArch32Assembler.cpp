...
void CAArch32Assembler::Vqsub_I8(QUAD_REGISTER qd, QUAD_REGISTER qn, QUAD_REGISTER qm)
{
	uint32 opcode = 0xF2000250;
	opcode |= FPSIMD_EncodeQd(qd);
	opcode |= FPSIMD_EncodeQn(qn);
	opcode |= FPSIMD_EncodeQm(qm);
	WriteWord(opcode);
...
void CAArch32Assembler::Vbsl(QUAD_REGISTER qd, QUAD_REGISTER qn, QUAD_REGISTER qm)
{
	uint32 opcode = 0xF3100150;
	opcode |= FPSIMD_EncodeQd(qd);
	opcode |= FPSIMD_EncodeQn(qn);
	opcode |= FPSIMD_EncodeQm(qm);
	WriteWord(opcode);
...
void CAArch32Assembler::Vneg_F32(QUAD_REGISTER qd, QUAD_REGISTER qm)
{
	uint32 opcode = 0xF3B907C0;
	opcode |= FPSIMD_EncodeQd(qd);
	opcode |= FPSIMD_EncodeQm(qm);
	WriteWord(opcode);
}
...
void CAArch32Assembler::Vceq_I8(QUAD_REGISTER qd, QUAD_REGISTER qn, QUAD_REGISTER qm)
{
	uint32 opcode = 0xF3000850;
	opcode |= FPSIMD_EncodeQd(qd);
	opcode |= FPSIMD_EncodeQn(qn);
	opcode |= FPSIMD_EncodeQm(qm);
	WriteWord(opcode);
...
void CAArch32Assembler::Vceq_I16(QUAD_REGISTER qd, QUAD_REGISTER qn, QUAD_REGISTER qm)
{
	uint32 opcode = 0xF3100850;
	opcode |= FPSIMD_EncodeQd(qd);
	opcode |= FPSIMD_EncodeQn(qn);
	opcode |= FPSIMD_EncodeQm(qm);
	WriteWord(opcode);
