...
namespace Jitter
{
	...
	private:
		...
		{
			static OpRegType OpReg() { return &CAArch64Assembler::Sqsub_16b; }
		};
		...
		{
			static OpRegType OpReg() { return &CAArch64Assembler::Fneg_4s; }
		};
		...
		struct MDOP_TOINT32_TRUNC_S : public MDOP_BASE2
		{
		...
		{
			static OpRegType OpReg() { return &CAArch64Assembler::Cmltz_4s; }
		};
		...
		void Emit_Md_BitSelect_RegVarVarVar(const STATEMENT&);
